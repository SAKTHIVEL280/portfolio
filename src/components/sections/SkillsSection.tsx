    ...
    <section ref={sectionRef} id="skills" className="relative">
      ...
      <div className="relative w-full" style={{ marginTop: "-1px" }}>
        <svg viewBox="0 0 1440 320" className="w-full block" preserveAspectRatio="none" style={{ height: "clamp(160px, 25vw, 400px)" }}>
          <path ref={wavePath1} d="M0,120 C180,20 360,220 540,80 C720,-40 900,200 1080,60 C1260,-20 1380,180 1440,100 L1440,320 L0,320 Z" fill="hsl(var(--inv-wave-1))" />
          <path ref={wavePath2} d="M0,160 C200,60 400,260 600,100 C800,0 1000,240 1200,120 C1350,40 1400,200 1440,140 L1440,320 L0,320 Z" fill="hsl(var(--inv-wave-2))" />
          <path ref={wavePath3} d="M0,200 C240,100 480,280 720,150 C960,60 1200,260 1440,180 L1440,320 L0,320 Z" fill="hsl(var(--inv-wave-3))" />
        </svg>
      </div>

      {/* Main Content */}
      <div className="w-full" style={{ background: "hsl(var(--inv-bg))" }}>
        <div className="px-8 md:px-16 lg:px-24 pb-32 pt-8">
          {/* Header */}
          <div className="mb-20">
            <p className="text-xs tracking-[0.3em] uppercase mb-4 font-body" style={{ color: "hsl(var(--inv-muted))" }}>
              What I work with
            </p>
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.9] tracking-tight" style={{ color: "hsl(var(--inv-fg))" }}>
              Skills &<br />Stack
            </h2>
          </div>
          ...
          <div ref={cardsRef} className="space-y-16">
            {/* Core */}
            <div>
              <h3 className="text-sm tracking-[0.2em] uppercase mb-6 pb-3 font-body" style={{ color: "hsl(var(--inv-muted))", borderBottom: "1px solid hsl(var(--inv-border))" }}>
